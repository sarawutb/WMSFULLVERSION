...
//
//     final productsCountStock = productsCountStockFromJson(jsonString);

import 'dart:convert';

class ProductsCountStock {
  ProductsCountStock({
    this.itemCode,
    this.itemName,
    this.unitStandard,
  ...
  factory ProductsCountStock.fromRawJson(String str) =>
      ProductsCountStock.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ProductsCountStock.fromJson(Map<String, dynamic> json) =>
      ProductsCountStock(
